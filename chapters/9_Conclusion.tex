...
\textcolor{blue}{The evaluation showed that the workflow achieves roughly 66~\% accuracy, and keeps false negatives to a low rate (3--5~\%). It also shows the benefits from the availability of Java–to–native contextual information, through the \glsxtrlong{jcg}, which improves both precision and overall stability.} \textcolor{red}{Taken together, these results provide quantitative evidence that the system is well suited as a fast, automated first-line filter for vulnerability assessment.}
