...
\begin{figure}[!ht]
    ...
    \caption{Structure of the implementation (modules, data flow, and orchestration logic).}
...
\begin{itemize}
    ...
    A variant of this prompt is used when the Java call graph is unavailable; in this case, the model is not required to reason about the Java-side control flow.  
...
\begin{enumerate}
    ...
    A complete flow graph of the application is first generated using FlowDroid\footnote{https://github.com/secure-software-engineering/FlowDroid}, which statically analyses the APK and produces a comprehensive call graph covering all possible execution paths.  
