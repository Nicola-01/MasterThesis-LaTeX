...
These apps were selected from the POIROT corpus and represent a mixture of media, banking, utilities, games, and communication applications.
...
\textcolor{red}{Da controllare le versioni}
