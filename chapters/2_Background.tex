...
\subsection{MCP Host}
MCP Host is the \gls{ai} application that coordinates and manages one or multiple \gls{mcp} clients. It maintains user experience, orchestrates connections to configured servers, and routes model/tool interactions \cite{mcp-architecture}.  
