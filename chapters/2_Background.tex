...
\begin{enumerate}
  ...
  \item The server executes the tool (e.g., get app manifest with Jadx, decompile e a function with Ghidra) and returns structured results to the client. % tool exec
