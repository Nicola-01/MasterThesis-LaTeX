...
\begin{enumerate}
    ...
    \item The native function \texttt{mp4\_write\_one\_h264} tears down the encoder context on malformed input: it closes the file, frees multiple internal buffers, and finally frees the global structure \texttt{iniPacker\_global}.
